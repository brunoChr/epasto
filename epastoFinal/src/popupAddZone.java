	...
	public popupAddZone(AppliController appliController) {
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				nomZone = textField.getText();
				if (!textField_1.getText().isEmpty() && (!nomZone.isEmpty()) ){
					if(!_appliController.getAppliModel().estValide(nomZone)){
		...
		btnParcourir.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
			    JFileChooser chooser = new JFileChooser("D:\\Documents\\b.christol\\Desktop\\kml");
